          ...
          <div class="clinic-card h-100 p-4">
            ...
            <div class="mb-3">
              <div class="d-flex align-items-center justify-content-between">
                ...
                @endphp
                <span class="badge {{ $waitingCount > 0 ? 'bg-warning' : 'bg-success' }} text-dark" title="People currently active in queue">
                  {{ $waitingCount }} {{ $waitingCount == 1 ? 'person' : 'people' }} active
                </span>
              </div>
              @if($waitingCount > 0)
                <small class="text-muted">
                  <i class="bi bi-clock me-1"></i>Estimated active queue time: {{ $waitingCount * 15 }} minutes
                </small>
              @else
