                  ...
                  <td>
                    <div class="btn-group btn-group-sm" role="group">
                      ...
                      @if($clinicType->clinics()->count() == 0)
                        <form method="POST" 
                              action="{{ route('admin.clinic-types.destroy', $clinicType) }}" 
                              class="d-inline"
                              onsubmit="return confirm('Are you sure you want to delete this clinic type?')">
                          @csrf
                          @method('DELETE')
                      ...
                      @else
                        <button type="button" 
                                ...
                                disabled
                                title="Cannot delete - clinic type is being used">
                          <i class="fas fa-trash"></i>
                        </button>
                      @endif
                    </div>
